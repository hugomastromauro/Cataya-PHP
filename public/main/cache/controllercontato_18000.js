...
return jQuery;}));+function($){'use strict';var dismiss='[data-dismiss="alert"]'
...
return this}
$(function(){$.support.transition=transitionEnd()})}(jQuery);$(function(){$('.carousel').carousel({interval:5000})
$('.tooltip-social').tooltip({selector:"a[data-toggle=tooltip]"})});
/*
								* Cataya CMS
								* Desenvolvido por Fabrik7
								* Cached: 2014-04-03 06:09:13, expire in: 2014-04-03 11:09:13
								*		 
							    */