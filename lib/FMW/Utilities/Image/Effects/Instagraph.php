...
namespace FMW\Utilities\Image\Effects;
...
class Instagraph {
     ...
     * @param string $output
     */
    public static function factory($image, $output, $path)
    {
        return new Instagraph($image, $output, $path);
    }
     ...
     * @throws Exception
     */
    public function __construct($image, $output, $path)
    {
    ...
    public function tempfile()
    {
        ...
        $this->_tmp = $this->_path . $this->_prefix.rand();
    ...
    public function nashville()
    {
        ...
        $this->frame($this->_tmp, dirname(__FILE__) . '/' . __FUNCTION__);
